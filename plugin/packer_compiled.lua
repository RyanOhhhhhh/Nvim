...
_G.packer_plugins = {
  ...
  ["clangd_extensions.nvim"] = {
    loaded = true,
    path = "/home/Ryan/.local/share/nvim/site/pack/packer/start/clangd_extensions.nvim",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/home/Ryan/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
